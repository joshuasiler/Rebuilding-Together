<?php /* You can manually modify this file before installing (renaming this file to plog-config.php before
 ...
 * or Albums) */ define('PLOGGER_CHMOD_DIR', 0755); /* Define the Plogger file permissions. Change permissions if you are having issues with viewing,
 * deleting, or moving images within Plogger (i.e. Pictures) */ define('PLOGGER_CHMOD_FILE', 0644); /* Is Plogger embedded in another program, like WordPress?
 * 1/0 (True/False) if set will overrule automatic check */ define('PLOGGER_EMBEDDED', ''); /* Define a directory path to save session variables if you are having trouble logging in or 
Plogger is
 * telling you that you have session.save_path issues and/or if your server php.ini setup has a
 * blank session.save_path php.ini variable */ define('PLOGGER_SESSION_SAVE_PATH', ''); /* Plogger localized language, defaults to English. Change this to localize Plogger.
 ...
 * Do not leave this running if gallery is functioning properly. */ define('PLOGGER_DEBUG', '');
?>
